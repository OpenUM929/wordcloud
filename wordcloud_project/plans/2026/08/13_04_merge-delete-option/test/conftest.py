"""13_04 테스트 fixture — 13_01/test/conftest.py 와 동일 구성(복제).

서버 기동 없이 임시 sqlite 파일로 검증한다(DL-12). 13_01의 conftest를 pytest
plugin으로 직접 재사용하기 어려워(비루트 conftest의 pytest_plugins 제약)
동일 내용을 복제한다 — 원본이 바뀌면 이 파일도 함께 갱신 필요.
"""
import os
import sys
import sqlite3
